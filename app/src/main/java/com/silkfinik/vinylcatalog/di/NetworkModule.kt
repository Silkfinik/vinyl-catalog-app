...
import com.silkfinik.vinylcatalog.BuildConfig
import com.silkfinik.vinylcatalog.data.remote.AuthInterceptor
...
object NetworkModule {
    ...
    fun provideOkHttpClient(): OkHttpClient {
        ...
        return OkHttpClient.Builder()
            ...
            .addInterceptor(AuthInterceptor(BuildConfig.DISCOGS_TOKEN))
            .build()
    }
